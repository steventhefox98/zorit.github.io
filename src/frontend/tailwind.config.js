  ...
  theme: {
    ...
    extend: {
      ...
      colors: {
        ...
        purple: {
          50:  'oklch(0.97 0.04 295)',
          100: 'oklch(0.93 0.07 295)',
          200: 'oklch(0.85 0.12 295)',
          300: 'oklch(0.75 0.17 295)',
          400: 'oklch(0.65 0.22 295)',
          500: 'oklch(0.55 0.25 295)',
          600: 'oklch(0.45 0.22 295)',
          700: 'oklch(0.35 0.18 295)',
          800: 'oklch(0.25 0.12 295)',
          900: 'oklch(0.16 0.07 295)',
          950: 'oklch(0.10 0.04 295)',
        }
      },
      borderRadius: {
        lg: 'var(--radius)',
      ...
      boxShadow: {
        ...
        'purple-glow': '0 0 20px oklch(0.62 0.22 295 / 0.4), 0 0 40px oklch(0.62 0.22 295 / 0.2)',
        'purple-glow-lg': '0 0 40px oklch(0.62 0.22 295 / 0.5), 0 0 80px oklch(0.62 0.22 295 / 0.25)',
        'pixel': '4px 4px 0px oklch(0.10 0.04 295)',
        'pixel-purple': '4px 4px 0px oklch(0.30 0.15 295)',
      },
      keyframes: {
        'accordion-down': {
          from: { height: '0' },
